...
const Dashboard: React.FC = () => {
  ...
  const expiringProducts = products
    .filter((p) => !isExpired(p.expiryDate) && isExpiringSoon(p.expiryDate))
    .slice(0, 5);
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-5 pb-24 min-h-screen bg-body">
      ...
      <div className="bg-linear-to-r from-primary to-primary-dark rounded-2xl p-5 text-white mb-6 shadow-lg">
      ...
      <div className="bg-card rounded-2xl shadow-md mb-6 overflow-hidden">
